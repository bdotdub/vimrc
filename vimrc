...
" Quick way to open up godoc
autocmd FileType go map go :GoDoc<CR>

" Quick way to toggle test file
autocmd FileType go command! R GoAlternate
...
" Don't conceal links for markdown
